							...
							<div className="pt-6">
								{user ? (
									...
									<div className="space-y-4">
											...
											<div>
												...
												<div className="relative">
													...
													<input
														...
														className="w-full pl-10 pr-4 py-2 text-sm border border-zinc-300 rounded-xl focus:bg-zinc-50 focus:outline-none focus:ring-2 focus:ring-zinc-100 focus:border-transparent text-zinc-900"
														required
													/>
												</div>
											</div>
										...
										<div className="text-center bg-zinc-100 rounded-b-xl p-2">
