...
export const SEO_CONFIG = {
	...
	// Documentation
	"/docs": {
		title: "Documentation - Kixi",
		description:
			"Complete documentation for Kixi. Learn how to set up, configure, and deploy your SaaS application.",
	...
	"*": {
		title: "Kixi - Build Your SaaS in Minutes",
		description:
