...
const BlogPostByIdPage = () => {
	...
	if (blog.status !== "published") {
		return (
			<>
				<Head>
					<title>Blog Post Not Available - YourApp</title>
				</Head>
				<div className="min-h-screen flex flex-col">
					<Navbar />
					<div className="flex-1 flex items-center justify-center">
						...
						<div className="flex items-center justify-between flex-wrap gap-3 mb-4">
							...
							<div className="flex items-center gap-2">
								...
								<motion.a
									...
									className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-500 hover:bg-blue-600 text-white rounded-xl transition-colors text-xs font-medium"
...
export default BlogPostByIdPage;
